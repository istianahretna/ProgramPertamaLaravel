...
<style type="text/css">
  ...
  <div class="form-floating">
    <label for="floatingInput"> Name </label>
      <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" id="floatingInput" placeholder="Name" value="{{ old('name') }}">
      @if($errors->has('name'))
    ...
    <div class="form-floating">
      ...
      <input type="password" name="password_confirmation" id="inputpassword" class="form-control {{ $errors->has('password_confirmation') ? 'is-invalid' : '' }}" id="floatingPassword" placeholder="re-Password">      
